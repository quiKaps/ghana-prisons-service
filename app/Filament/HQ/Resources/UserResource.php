            ...
            Section::make(fn($record) => $record->serial_number . '-' . strtoupper($record->rank) . '-' . $record->name . ' Details')
                    ->schema([
                        ...
                        TextEntry::make('rank')
                            ...
                            ->formatStateUsing(fn($state) => match ($state) {
                        'dg' => 'Director-General of Prisons (DG)',
                        'ddg' => 'Deputy Director-General of Prisons (DDGP)',
                        'dop' => 'Director of Prisons (DOP)',
                        'ddp' => 'Deputy Director of Prisons (DDP)',
                        'adp' => 'Assistant Director of Prisons (ADP)',
                        'csp' => 'Chief Superintendent of Prisons (CSP)',
                        'supt' => 'Superintendent of Prisons',
                        'dsp' => 'Deputy Superintendent of Prisons (DSP)',
                        'asp' => 'Assistant Superintendent of Prisons (ASP)',
                        'sco' => 'Senior Chief Officer (SCO)',
                        'co' => 'Chief Officer (CO)',
                        'sgt' => 'Sergeant (Sgt)',
                        'cpl' => 'Corporal (Cpl)',
                        'l/cpl' => 'Lance Corporal (L/Cpl)',
                        '2co' => 'Second Class Officer (2CO)',
                    }),
