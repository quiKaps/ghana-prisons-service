...
class RemandImporter extends Importer
{
  ...
  return [
    ...
    {   
        ...
        return RemandTrial::firstOrNew([
            'serial_number' => $this->data['serial_number'],
             'detention_type' => RemandTrial::TYPE_REMAND,
        ], [
            ...
            'mode_of_discharge' => $this->data['mode_of_discharge'] ?? null,
            'discharged_by' => $this->data['discharge_by'] ?? null,
    ...
    {
        $body = 'Your remand import has completed and ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
    ...
    protected function beforeSave(): void
    {
        ...
        if (!isset($this->data['detention_type'])) {
            $this->data['detention_type'] = RemandTrial::TYPE_REMAND;
        }
