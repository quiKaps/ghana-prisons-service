...
use App\Filament\Clusters\Reports\Resources\TrialReportResource\Pages;
use App\Filament\Clusters\Reports\Resources\TrialReportResource\RelationManagers;

class TrialReportResource extends Resource
{
    protected static ?string $model = RemandTrial::class;

    protected static ?string $navigationLabel = 'Trial Reports';
   ...
   // protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    ...
    {
        return [
            'index' => Pages\ManageTrialReports::route('/'),
        ];
    }
