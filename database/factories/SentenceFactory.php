...
class SentenceFactory extends Factory
{
    ...
    {
        $epd = $this->faker->dateTimeBetween('now', '+5 years');
        $lpd = $this->faker->dateTimeBetween('+5 years', '+10 years');
        ...
        return [
            ...
            'sentence' => $this->faker->randomElement(['5 years', '10 years', 'Life', 'Death']),
            //'total_sentence' => $this->faker->randomElement(['5 years', '10 years', 'Life', 'Death']),
